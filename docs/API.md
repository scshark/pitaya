...
Below is a very barebones example of a handler definition, for a complete working example, check the [cluster demo](https://github.com/scshark/pitaya/tree/master/examples/demo/cluster).

```go
import (
  "github.com/scshark/pitaya"
  "github.com/scshark/pitaya/component"
)
...
For a complete working example, check the [cluster demo](https://github.com/scshark/pitaya/tree/master/examples/demo/cluster).
